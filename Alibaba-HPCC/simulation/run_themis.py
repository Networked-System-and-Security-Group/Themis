...
def modify_config(base_config_path, new_config_path, xxx):
    ...
    lines[6] = f"FLOW_FILE mix/UnfairPenalty/Inter-DC/ExprGroup/flow_Web_{xxx}_1:10.txt\n"
    lines[7] = f"FCT_OUTPUT_FILE mix/UnfairPenalty/Inter-DC/ExprGroup/flow_Web_{xxx}/fct.txt\n"
    lines[8] = f"PFC_OUTPUT_FILE mix/UnfairPenalty/Inter-DC/ExprGroup/flow_Web_{xxx}/pfc.txt\n"
...
def run_simulation(xxx):
    ...
    new_config_path = f"./mix/config_Web_{xxx}.txt"
